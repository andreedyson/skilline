    ...
    <section id="about" className="max-w-[2000px] mx-auto px-6 py-12 lg:px-20">
        <div className="flex flex-col items-center gap-6 mb-20 text-center">
            ...
            <div className="flex flex-col justify-between w-full gap-14 lg:flex-row">
                <div className="relative flex flex-col items-center justify-center p-12 bg-cover lg:w-[600px] lg:h-[400px] bg-[url('./src/assets/instructor.png')] rounded-[20px]">
                ...
                <div className="relative flex flex-col items-center justify-center p-12 bg-cover lg:w-[600px] lg:h-[400px] bg-[url('./src/assets/students.png')] rounded-[20px]">
